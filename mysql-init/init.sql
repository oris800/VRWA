...
(1123, 'alice', '8g#K@pZ!v$Lq7bF*e%', 'Favorite color?', 'blue', 452, 0, 0, NULL, NULL, 0),
(1516, 'bob', 'wR4$nC&jH9@s!fT^m2', 'First pet name?', 'max', 112, 0, 0, NULL, NULL, 0),
(1623, 'charlie', 'zX9*pLq!v@kG#dF&hS', 'City of birth?', 'new york', 589, 0, 0, NULL, NULL, 0),
...
(4321, 'ivan', 'hG2^jK&lM4@z!xV#cB', 'What is 2+2?', '4', 15, 0, 0, NULL, NULL, 0),
(4815, 'judy', 'bN8*mK&lP5@q!wE#rT', 'Favorite color?', 'green', 333, 0, 0, NULL, NULL, 0),
(5543, 'mallory', 'vB9!nJ&mK7@l!zX*cC', 'First pet name?', 'buddy', 248, 1, 0, NULL, NULL, 0),
(5892, 'mike', 'mK4^lP&oI6@a!sD#fG', 'City of birth?', 'tokyo', 489, 0, 0, NULL, NULL, 0),
(6007, 'nancy', 'lP5*kG&jH8@d!fG^hJ', 'Favorite food?', 'burger', 176, 0, 0, NULL, NULL, 0),
(6652, 'oscar', 'jH1#fG&dK3@s!aP*oI', 'What is 3+3?', '6', 550, 0, 0, NULL, NULL, 0),
(7331, 'peggy', 'gD7^sA&pL2@o!iU*yT', 'Favorite color?', 'yellow', 9, 0, 0, NULL, NULL, 0),
(7890, 'quentin', 'sA8*dF&gH9@p!oI^uY', 'First pet name?', 'max', 599, 0, 0, NULL, NULL, 0),
(8129, 'rupert', 'dF2!gH&jK1@u!yT*rE', 'City of birth?', 'paris', 101, 0, 0, NULL, NULL, 0),
(8200, 'trudy', 'fG3^hJ&kL4@r!eW#qA', 'What is your favorite Metroidvania game that came out in september 2025?', 'Hollow Knight: Silksong', 444, 1, 0, NULL, NULL, 0),
(8842, 'victor', 'hJ9*kL&mN5@q!aZ#wS', 'Favorite movie?', 'The Matrix', 287, 0, 0, NULL, NULL, 0),
(9014, 'walter', 'kL6!mN&bV7@w!sX#eD', 'Favorite food?', 'pasta', 365, 0, 0, NULL, NULL, 0),
(9981, 'wendy', 'mN2^bV&cZ8@e!dC*rF', 'Favorite color?', 'black', 512, 0, 0, NULL, NULL, 0),
(9984, 'carlos', 'bV1#cZ&xS0@r!fV*tG', '&^#@!()@!@#$%', '#@!%^&*()_+|}{POIUYTREWQ', 296, 0, 1, 'f1e2d3c4b5a6f1e2d3c4b5a6f1e2d3c4', 'b9a18f7d6e5c4b3a291807f6e5d4c3b2', 0);
